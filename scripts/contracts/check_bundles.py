...
SIGNATURES = {
    ...
    "memrchr": (["ptr", "scalar", "scalar"], "ptr"),
    "strlen": (["ptr"], "scalar"),
    "strnlen": (["ptr", "scalar"], "scalar"),
    "strchr": (["ptr", "scalar"], "ptr"),
    "strrchr": (["ptr", "scalar"], "ptr"),
    "strstr": (["ptr", "ptr"], "ptr"),
    "strpbrk": (["ptr", "ptr"], "ptr"),
    "strcmp": (["ptr", "ptr"], "scalar"),
    "strncmp": (["ptr", "ptr", "scalar"], "scalar"),
    "strspn": (["ptr", "ptr"], "scalar"),
    "strcspn": (["ptr", "ptr"], "scalar"),
    "strncpy": (["ptr", "ptr", "scalar"], "ptr"),
    "strlcpy": (["ptr", "ptr", "scalar"], "scalar"),
...
EXCLUDED = {
    ...
    "strtoll": "pointer-to-pointer output (endptr); #41 boundary",
    "strsep": "pointer-to-pointer state output (stringp)",
    "strtok_r": "pointer-to-pointer state output (saveptr)",
